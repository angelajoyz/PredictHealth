  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/auth/register`, {
        ...
        body: JSON.stringify({ username, email, password, full_name: `${firstName.trim()} ${lastName.trim()}`.trim() }),
      });
          ...
          {!success ? (
            <>
              ...
              <Box sx={{ display: 'flex', gap: 1.5, mb: 1.5 }}>
                <Box sx={{ flex: 1 }}>
                  <Typography sx={{ fontSize: 11.5, fontWeight: 600, color: T.t2, mb: 0.75 }}>First Name</Typography>
                ...
                <Box sx={{ flex: 1 }}>
                  <Typography sx={{ fontSize: 11.5, fontWeight: 600, color: T.t2, mb: 0.75 }}>Last Name</Typography>
              ...
              <Box sx={{ mb: 1.5 }}>
                ...
                <TextField fullWidth placeholder="Choose a username" variant="outlined"
                  value={username}
              ...
              {/* Email */}
              <Box sx={{ mb: 1.5 }}>
                <Typography sx={{ fontSize: 11.5, fontWeight: 600, color: T.t2, mb: 0.75 }}>Email</Typography>
                <TextField fullWidth placeholder="Enter your email" variant="outlined"
                  type="email"
                  value={email}
              ...
              <Box sx={{ mb: 1.5 }}>
                ...
                <TextField fullWidth placeholder="At least 8 characters"
            ...
            <Box sx={{ textAlign: 'center', mt: 1 }}>
              <Typography sx={{ fontSize: 13, color: T.t3, mb: 3, lineHeight: 1.7 }}>
